            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="room-details-item">
                        <img src="<?php echo e(asset($rooms->images)); ?>" style="width:800px; height:400px" alt="ảnh" />
                        <div class="rd-text">
                            <div class="rd-title">
                            ...
                            <h2><?php echo e(number_format($rooms->price, 0, ',', '.')); ?><span>/Pernight</span></h2>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Mã phòng:</td>
                                        <td><?php echo e($rooms->room_id); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($rooms->categories->category_name); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <p class="f-para">
                                <?php echo e($rooms->mota); ?>
                ...
                <div class="col-lg-4">
                    <?php echo $__env->make('hoadon.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
...
<?php /**PATH C:\xampp\htdocs\php3_laravel\resources\views/user/room-detail.blade.php ENDPATH**/ ?>